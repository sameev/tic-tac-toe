...
const Square = ( {player}: Props ) => {
  ...
  return (
    <div className={`h-36 border-solid border-4 corder-slate-200 font-display text-7xl text-center flex justify-center items-center cursor-pointer ${hoverStyle}`}>
